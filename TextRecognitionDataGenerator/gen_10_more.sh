#/bin/bash
python run.py --language cn --length 12 --format 32 --loop_times 40 --output_dir "outs/train/black_1/"
python run.py --language cn --length 12 --format 32 --loop_times 20 --output_dir "outs/test/black_1/"
python run.py --language cn --length 12 --format 32 --loop_times 20 --output_dir "outs/train/black_1/" --text_color "#00B2EE"
python run.py --language cn --length 12 --format 32 --loop_times 10 --output_dir "outs/test/black_1/" --text_color "#00B2EE"
